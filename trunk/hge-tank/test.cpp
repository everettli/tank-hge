...
#include "E:\hge\hge181\include\hge.h"
#include "E:\hge\hge181\include\hgefont.h"
#include "E:\hge\hge181\include\hgeanim.h"
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	if(hge->System_Initiate())
	{
		...
		animtex=hge->Texture_Load("ren.jpg");
		if(!bgtex || !tex)
		{
		...
		spr=new hgeSprite(tex,293,355,107,102);
		spr->SetTextureRect(634,157,102,100,false);
		...
		panim = new hgeAnimation(animtex,10,24,0,0,64.2,63);
		panim->SetMode(HGEANIM_LOOP);
		panim->Play();
